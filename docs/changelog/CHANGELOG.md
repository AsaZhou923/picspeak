...
## 2026-09-26 - 长廊先看作品，点评说明更清楚

日期：2026-09-26

### 这次更新

这轮界面调整已上线：长廊更快展示公开作品，点评结果与下一步操作也更容易看懂。

- 进入长廊后先看到照片；作品卡片减少装饰，保留作者、评分和打开点评的清晰入口。
- 公开点评示例的介绍更简短；手机上直接显示最需要改进的评分依据。
- 导航、筛选和操作控件更方便使用键盘与触屏，小号文字也更容易辨认。
- 长廊加载失败与“暂时没有作品”分开提示，并提供重试入口。
