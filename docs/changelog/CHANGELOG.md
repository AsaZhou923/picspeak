...
<a id="2026-09-24-gallery-browsing-fixes"></a>

## 2026-09-24 - 图库浏览与更新提醒修复

日期：2026-09-24

### 这次更新

修复图库列数切换和更新提醒，并缩小近期作品区域，让浏览照片更顺手。

- 近期作品每位作者只保留 1 件代表作品，模块展示也更紧凑。
- 图库的 1 / 2 / 3 列选择会作用到实际作品列表，并保存你的浏览偏好。
- 新版本更新提醒会在首次进入首页或图库时显示；同一版本确认后不会反复弹出。

---

<a id="2026-09-24-critique-organization-and-sharing"></a>

## 2026-09-24 - 点评后的整理、浏览与分享

日期：2026-09-24

### 这次更新

点评结果页之后的整理、浏览和分享动作现在更集中，适合把一次评图继续保存、查找、展示或打印。

- 私人标签、备注和搜索用于整理自己的点评记录，回头找照片、问题和处理线索更直接。
- 图库浏览支持列数、紧凑模式、缩放、上下篇切换和近期作品入口，适合连续看作品与点评。
- 分享链接可以独立撤销；公开主页可以自行选择展示内容，减少公开范围和私人记录混在一起。
- 点评内容可以导出 PNG 图片卡，也可以打开打印摘要，用于保存、复盘或交给别人查看。
