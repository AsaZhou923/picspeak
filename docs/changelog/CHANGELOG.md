...
## 2026-09-08 - 高分更有依据，进步对比更清楚（准备中）

日期：2026-09-08

### 这次更新

正在准备一轮评分更新，让高分更重视照片本身的完成度，并让前后进步的比较更可靠。

- 高分判断将再次核对构图、光线和表达的实际效果，同时保留成立的剪影、留白、黑白等风格。
- 进步统计将按相同评分标准比较，不把不同标准的旧分数直接混算。
- 新标准的评价标签将与实际分档一致，7 分段不会提前显示成 8 分段。
