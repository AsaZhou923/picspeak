...
class ExportOperationalHealthSnapshotScriptTests(unittest.TestCase):
    ...
    def test_main_uses_dated_default_output_when_output_is_omitted(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            output_path = Path(tmp_dir) / '2026-05-11-operational-health-snapshot.md'
            args = SimpleNamespace(
                start_date='2026-05-11',
                end_date='2026-05-11',
                output=None,
            ...
            ), patch.object(script, 'render_operational_health_markdown', return_value='# report\n'):
                script.main()
            ...
            self.assertEqual(kwargs['filename_stem'], 'operational-health-snapshot')
