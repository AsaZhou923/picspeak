...
const COPY: Record<Locale, GuidanceCopy> = {
  en: {
    ...
    subtitle: 'Choose an original and one goal. Compare an edited or newly taken photo, then revisit every attempt here.',
  ...
  zh: {
    ...
    subtitle: '选一张原片、定一个目标，上传修改版或重拍照片。每次尝试和比较结果都会留在这里。',
  ...
  ja: {
    ...
    subtitle: '元写真と目標を選び、編集後や撮り直した写真を比較します。各試行と結果はここに残ります。',
