...
const COPY: Record<Locale, {
  ...
  zh: {
    title: '私人整理',
    body: '标签和备注只用于你的历史回看，不会进入公开 Gallery 或分享页。',
    selected: '正在整理',
  ...
  en: {
    ...
    body: 'Tags and notes are only for your own history. They are not added to Gallery or share pages.',
    selected: 'Organizing',
  ...
  ja: {
    title: '非公開整理',
    body: 'タグとメモは自分の履歴用です。Gallery や共有ページには出ません。',
    selected: '整理中',
