...
const ZH_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    description:
      '把抽象的照片反馈翻成下一次拍摄能执行、能复盘的短清单，才能真正帮助你改进构图、光线和主体表达。本文提供从"问题描述"到"现场动作"的翻译模板、题材示例和验证方法。',
    excerpt:
  ...
  },
  {
    ...
    description:
      '逆光过曝、混合色温、阴影无细节、直射硬光和光线无方向感，是 AI 点评最常标出的五个光线问题。本文拆解每类问题的现场判断、拍摄角度、测光和补光方法，帮助你在按下快门前避开常见失误。',
    excerpt:
