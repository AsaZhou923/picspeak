...
const HOME_INTENT_COPY: Record<ContentConversionLocale, HomeIntentEntrance[]> = {
  zh: [
    ...
    },
    {
      ...
      label: '回访用户',
      title: '用重拍验证上次建议',
      body: '选择一张历史原片，再上传重拍图，让 GPT-5.6 比较五个摄影维度的真实变化。',
      cta: '开始重拍对比',
      href: '/retake',
      source: 'home_direct',
    },
  ...
  en: [
    ...
    },
    {
      ...
      body: 'Choose a previous original, upload the retake, and let GPT-5.6 measure change across five dimensions.',
  ...
  ja: [
    ...
    },
    {
      ...
      label: '再訪ユーザー',
      title: '再撮影で前回の提案を検証',
      body: '過去の元写真を選び、再撮影をアップロードして、GPT-5.6 が5項目の変化を測ります。',
      cta: '再撮影比較を始める',
      href: '/retake',
      source: 'home_direct',
    },
