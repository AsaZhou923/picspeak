...
const translations = {
  zh: {
    ...
    plan_guest_name: '游客',
    plan_guest_quota: '每天 5 次，每月 50 次',
    plan_guest_feature: '仅限 Flash 即时点评',
    plan_guest_feature_2: '不保存历史记录',
    plan_free_name: 'Free',
    plan_free_quota: '100 次 / 月，每天最多 10 次',
    plan_free_feature: '支持 Flash 与 Pro',
    plan_free_feature_2: '历史记录保留 30 天',
    plan_free_feature_3: '适合持续练习与日常复盘',
    plan_pro_name: 'Pro',
    plan_pro_quota: '1000 次 / 月',
    ...
    usage_login_unlock_body: '游客每天可用 5 次，不保留历史。Google 登录后升级为 Free，可获得每月 100 次、每天最多 10 次，以及 30 天历史记录。',
    ...
    err_quota_exceeded_body: '你已达到当前套餐可用上限。Free 同时受每日和每月次数限制，Pro 受每月总额度限制。',
  ...
  en: {
    ...
    plan_guest_quota: '5 / day, 50 / month',
    plan_guest_feature: 'Flash only',
    plan_guest_feature_2: 'No saved history',
    plan_free_name: 'Free',
    plan_free_quota: '100 / month, up to 10 / day',
    plan_free_feature: 'Flash + Pro modes',
    plan_free_feature_2: '30-day history retention',
    plan_free_feature_3: 'Built for ongoing practice',
    plan_pro_name: 'Pro',
    plan_pro_quota: '1000 / month',
    ...
    usage_login_unlock_body: 'Guests get 5 critiques per day with no saved history. Sign in with Google to upgrade to Free for 100 critiques per month, up to 10 per day, plus 30-day history.',
    ...
    err_quota_exceeded_body: 'You have reached the available quota for your current plan. Free has both daily and monthly limits; Pro only has a monthly cap.',
  ...
  ja: {
    ...
    plan_guest_name: 'ゲスト',
    plan_guest_quota: '1日5回、月50回',
    plan_guest_feature: 'Flash のみ',
    plan_guest_feature_2: '履歴保存なし',
    plan_free_name: 'Free',
    plan_free_quota: '月100回、1日最大10回',
    plan_free_feature: 'Flash + Pro',
    plan_free_feature_2: '履歴は30日保存',
    plan_free_feature_3: '継続的な練習向け',
    plan_pro_name: 'Pro',
    plan_pro_quota: '月1000回',
    ...
    usage_login_unlock_body: 'ゲストは1日5回までで、履歴は保存されません。Google でサインインすると Free にアップグレードされ、月100回・1日最大10回と30日履歴が使えます。',
    ...
    err_quota_exceeded_body: '現在のプランで使える上限に達しました。Free は日次と月次、Pro は月次の上限があります。',
