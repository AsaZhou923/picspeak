...
const translations = {
  zh: {
    ...
    hero_desc: '上传照片，AI 从构图、光线、色彩、冲击力与技术五个维度给出详细点评，提供可落地的改进建议。',
    ...
    feature_pro_body: '深入剖析照片冲击力与创作意图，附带可落地改进建议',
    ...
    review_score_dims_basis: '构图 · 光线 · 色彩 · 冲击力 · 技术',
    ...
    score_dim_desc_impact: '评估照片带来的视觉冲击力、情感张力、主题表达和与观者的视觉共鸣。',
