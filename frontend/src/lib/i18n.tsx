...
const translations = {
  zh: {
    ...
    review_free_upgrade_title: '解锁 Pro，1000 次/月',
    ...
    faq_a3: '游客无需注册，每天可评 5 次（每月 50 次），但不保存历史记录；Free 账户（Google 登录）每月 100 次、每天最多 10 次，历史保留 30 天；Pro 账户每月 1000 次、不限每日次数、永久保留历史并享有队列优先处理。',
    faq_q4: '我的照片数据安全吗？',
  ...
  en: {
    ...
    review_free_upgrade_title: 'Unlock Pro — 1,000 / month',
    ...
    faq_a3: 'Guests need no sign-up: 5 critiques/day (50/month) but no saved history. Free (Google sign-in) gives 100/month, up to 10/day, with 30-day history retention. Pro unlocks 1,000/month, no daily cap, permanent history, and priority queue processing.',
  ...
  ja: {
    ...
    review_free_upgrade_title: 'Pro にアップグレード — 月1000回',
    ...
    faq_a3: 'ゲストは登録不要で 1 日 5 回（月 50 回）使えますが、履歴は保存されません。Free（Google サインイン）は月 100 回・1 日最大 10 回で 30 日間の履歴保存が可能です。Pro は月 1,000 回・日次上限なし・永久履歴保存・優先キュー処理を提供します。',
    faq_q4: '写真データは安全ですか？',
